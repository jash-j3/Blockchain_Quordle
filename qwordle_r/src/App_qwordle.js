...
const QApp = () => {
  ...
  useEffect(() => {
    const executeTransaction = async () => {
      ...
      const payload = {
        function: `${process.env.REACT_APP_ADDRESS}::qwordle::get_stats`,
        type_arguments: [],
      ...
      try {
        ...
        const transaction = {
          arguments: [],
          function: `${process.env.REACT_APP_ADDRESS}::qwordle::register`,
          type_arguments: [],
        };
        try {
      ...
      const gameStatus = {
        function: `${process.env.REACT_APP_ADDRESS}::qwordle::get_game_state`,
        type_arguments: [],
        arguments: [account.address],
      };
  ...
  const onReset = async () => {
    try {
      if (GS[0].length != 0) {
        const transaction = {
          arguments: [],
          function: `${process.env.REACT_APP_ADDRESS}::qwordle::reset`,
          type_arguments: [],
        };
        try {
          const pendingTransaction =
      ...
      if (isRowComplete(row)) {
        ...
        const executeTransaction = async () => {
          try {
            ...
            const submitGuess = {
              function: `${process.env.REACT_APP_ADDRESS}::qwordle::submit_guess`,
              type_arguments: [],
          ...
          // const submitGuess = {
          //   function:
          //     "0xf351504601d020cc2e0e4e7a43c4840419eff31fa1accb81c5d2a20861397940::qwordle::submit_guess",
          //   type_arguments: [],
  ...
  const handleInfoClick = () => {
    const statsTransaction = async () => {
      ...
      const payload = {
        function:
          "0x7653ff4b28a1da697bf2d75aeed4df1821926cedd0e889379593f2b7847f386e::qwordle::get_stats",
        type_arguments: [],
        arguments: [account.address],
      };
      try {
